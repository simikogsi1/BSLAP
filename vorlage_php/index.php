  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?seite=formular">Formular</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?seite=tabelleadresse">Adresse</a>
        </li>
          <li class="nav-item">
              <a class="nav-link" href="?seite=strasseinsert">Straße</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" href="?seite=strassenamen_change">Straßename Change</a>
          </li>
          <li class="nav-item">
    ...
    if(isset($_GET['seite']))
    {
      switch($_GET['seite'])
      {
        case 'tabelleadresse':
          ...
          case 'strassenamen_change':
              include 'page/strassenamen_change.php';
              break;
